# Pacman
yes | sudo pacman -Syu git noto-fonts-cjk festfetch zsh git neovim kitty gnome-disk-utility cups curl fcitx5 fcitx5-hangul fcitx5-mozc imagemagick bat nnn btop
